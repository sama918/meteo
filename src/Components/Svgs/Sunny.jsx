...
const Sunny = ({width='250px', height='250px'}) => {
    return (<div>
            <svg
                width={width}
                height={height}
                viewBox="0 0 100 100"
                role="img"
                aria-label="Icône météo ensoleillée"
            ...
            >
                <motion.g
                    ...
                    transition={{
                        ...
                        rotateZ: {duration: 50, repeat: Infinity}
                    }}
                >
		...
		c0-4.879,2.566-9.122,6.343-11.29c1.705-0.979,3.658-1.535,5.732-1.535C69.103,30.433,74.509,36.175,74.509,43.258z"/>
                    ...
                    <motion.g
                       ...
                       transition={{
                           ...
                           translateY: {ease: 'easeInOut', duration: 10,repeat: Infinity},
                           translateX: {ease: 'easeInOut', duration: 10 ,repeat: Infinity}
                       }}
                    >
